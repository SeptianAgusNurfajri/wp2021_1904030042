...
$id = $_GET['NIDN'];
$dafdos = query("SELECT * FROM tbl_dosen WHERE NIDN=$id");
    ...
    <div class="row">
        ...
        <div class="col-md-10 p-5 pt-5">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item">Pendidikan S1 : <?= $dafdos['Pendidikan_S1']; ?></li>
                <li class="list-group-item">Pendidikan S2 : <?= $dafdos['Pendidikan_S2']; ?></li>
                <li class="list-group-item">
                    <a href="hapus.php?NIDN=<?= $dafdos['NIDN']; ?>" onclick="confirm('apakah anda akan menghapus data ini?');" class="btn btn-danger" role="button">Hapus</a> |
